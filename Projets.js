...
const projectsData = {
    ...
    hermes: {
        ...
        content: `
            ...
            <h3>Conclusion</h3>
            <p>maginer le site d’une maison d’édition fictive m’a donné envie de travailler, un jour, pour une maison bien réelle. En intégrant sa charte graphique au mieux, j’ai réellement pris plaisir à construire un espace lisible, cohérent et accueillant.  
    ...
    traiteur: {
        ...
        content: `
            ...
            <p>Ce projet est actuellement en construction.</p>
        `,
        link: null,
        linkLabel: null
    }
...
function updateTransform() {
    gallery.style.transform = `translate(calc(-50% + ${offsetX}px), calc(-50% + ${offsetY}px)) scale(${scale})`;
}
